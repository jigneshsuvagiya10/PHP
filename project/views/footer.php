      ...
      <div class="container pb-lg-3">
        <div class="row footer-top-29">
          <div class="col-lg-4 col-md-6 footer-list-29 footer-1 mt-md-4">
            <a class="footer-logo mb-md-3 mb-2" href="#url"><img src="images/logo-icon.png" alt="" />Skill</a>
  ...
  <script src="<?php echo $BaseURLDynamic;?>js/jquery-3.3.1.min.js"></script>
  <script src="<?php echo $BaseURLDynamic;?>js/bootstrap.min.js"></script>

  <!-- Template JavaScript -->

  <!-- stats number counter-->
  <script src="<?php echo $BaseURLDynamic;?>js/jquery.waypoints.min.js"></script>
  <script src="<?php echo $BaseURLDynamic;?>js/jquery.countup.js"></script>
  <script>
    $('.counter').countUp();
  </script>
  <!-- //stats number counter -->
  ...
  <script src="<?php echo $BaseURLDynamic;?>js/owl.carousel.js"></script>
